@section('transaction', 'Unggah Karya')
                        ...
                        <div class="services-list owl-carousel">
                            ...
                            <div class="item animate" data-animate="fadeInUp">
                                <div class="service-box">
                                    <span class="service-icon">
                                        @if(!empty($data_user->grade) && !empty($data_user->university) && !empty($data_user->registration_form))
                            ...
                            <div class="item animate" data-animate="fadeInUp">
                                <div class="service-box">
                                    ...
                                    <h3>Unggah Karya</h3>
                                    <p>Upload karya terbaikmu yang selama ini telah kamu ciptakan</p>
                                </div>
                            </div>
                            </a>
                            <a href="#slide04">
                    ...
                    <div class="contact-section">
                        <div class="row">
                            <div class="col-md-6 mx-auto animate" data-animate="fadeInUp">
                                <form action="{{ route('save_data_tmt') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="input-field" style="text-align:left">
                                        <label for="grade" class="form-label" >Jenjang Pendidikan</label>
                                        <input id="grade" type="text" class="my-0 form-control @error('grade') is-invalid @enderror" name="grade" value="{{ (old('grade'))? old('grade') : (!empty($data_user->grade))? $data_user->grade :''}}" required autocomplete="grade">
                                    ...
                                    <div class="input-field" style="text-align:left">
                                        ...
                                        {!! (!empty($data_user->registration_form)) ? 'Data dan File tersimpan! <br><i><a href="'.public_path('userdocs2020/tmt/' . $data_user->registration_form).'"><i class="fa fa-check-circle"></i>  '. $data_user->registration_form.'</i></a>' :'' !!}
                                    ...
                                    <a href="document/Form_Daftar_3MT_prpn2020.pdf">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 wide-col-laptop">
                    ...
                    <div class="contact-section">
                        <div class="row">
                            <div class="col-md-6 mx-auto animate" data-animate="fadeInUp">
                                <form action="{{ route('save_creation_tmt') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="input-field" style="text-align:left">
                                        <label for="creation" class="form-label" >Unggah Karya <small class="text-warning">(max. 3 MB, pdf/doc/docx)</small></label>
                                        ...
                                        {!! (!empty($data_user->creation)) ? 'Bukti Pembayaran telah tersimpan! <br><i><a href="'.public_path('userdocs2020/tmt/' . $data_user->creation).'"><i class="fa fa-check-circle"></i>  '. $data_user->creation.'</i></a>' :'' !!}
            ...
            <div class="row">
                  ...
                  <div class="col-lg-6 col-md-7 col-12">
                      <div class="input-field" style="text-align:left">
                        ...
                        <br><br>
                        @if(!empty($data_user->grade) && !empty($data_user->university) && !empty($data_user->registration_form) && !empty($data_user->creation))
