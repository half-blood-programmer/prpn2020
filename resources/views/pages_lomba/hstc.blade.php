                            ...
                            <div class="item animate" data-animate="fadeInUp">
                                <div class="service-box">
                                    <span class="service-icon">
                                        @if(!empty($data_user->team_name) && !empty($data_user->captain) && !empty($data_user->teacher) && !empty($data_user->teacher_contact) && !empty($data_user->university) && !empty($data_user->registration_form))
                    ...
                    <div class="contact-section">
                        <div class="row">
                            <div class="col-md-6 mx-auto animate" data-animate="fadeInUp">
                                <form action="{{ route('save_data_hstc') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="input-field" style="text-align:left">
                                        <label for="teacher" class="form-label" >Nama Guru Pembimbing</label>
                                        <input id="teacher" type="text" class="my-0 form-control @error('teacher') is-invalid @enderror" name="teacher" required autocomplete="teacher" value="{{ (old('teacher'))? old('teacher') : (!empty($data_user->teacher))? $data_user->teacher :''}}">
                                    ...
                                    <div class="input-field" style="text-align:left">
                                        <label for="teacher_contact" class="form-label" >Kontak Guru Pembimbing</label>
                                        <input id="teacher_contact" type="text" class="my-0 form-control @error('teacher_contact') is-invalid @enderror" name="teacher_contact" required autocomplete="teacher_contact" value="{{ (old('teacher_contact'))? old('teacher_contact') : (!empty($data_user->teacher_contact))? $data_user->teacher_contact :''}}">
                                    ...
                                    <div class="input-field" style="text-align:left">
                                        <label for="university" class="form-label" >Asal Sekolah</label>
                                    ...
                                    <div class="input-field" style="text-align:left">
                                        ...
                                        {!! (!empty($data_user->registration_form)) ? 'Data dan File tersimpan! <br><i><a href="'.public_path('userdocs2020/hstc/' . $data_user->registration_form).'"><i class="fa fa-check-circle"></i>  '. $data_user->registration_form.'</i></a>' :'' !!}
                                    ...
                                    <a href="document/Form_Daftar_HSTC_prpn2020.pdf">
                                        <label class="btn" style="height:45px;background-color:wheat">Unduh Formulir Pendaftaran</label>
                                    </a>
                                    @if(!empty($data_user->team_name) && !empty($data_user->captain) && !empty($data_user->teacher) && !empty($data_user->teacher_contact) && !empty($data_user->university) && !empty($data_user->registration_form))
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 wide-col-laptop">
                    ...
                    <div class="contact-section">
                        <div class="row">
                            <div class="col-md-6 mx-auto animate" data-animate="fadeInUp">
                                <form action="{{ route('save_trans_hstc') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    <div class="input-field" style="text-align:left">
                                        ...
                                        {!! (!empty($data_user->transaction)) ? 'Bukti Pembayaran telah tersimpan! <br><i><a href="'.public_path('userdocs2020/hstc/' . $data_user->transaction).'"><i class="fa fa-check-circle"></i>  '. $data_user->transaction.'</i></a>' :'' !!}
            ...
            @if(Auth::user()->status == 0)
                  <div class="col-lg-6 col-md-7 col-12">
                      <div class="input-field" style="text-align:left">
                        ...
                        <br><br>
                        @if(!empty($data_user->team_name) && !empty($data_user->captain) && !empty($data_user->teacher) && !empty($data_user->teacher_contact) && !empty($data_user->university) && !empty($data_user->registration_form) && !empty($data_user->registration_form))
